...
class property_timeline_report(models.Model):
    ...
    def _table_query(self):
            ...
            SELECT
                ...
                LEFT JOIN (
                    ...
                    LEFT JOIN (
                        ...
                        WHERE aa.account_type = 'asset_cash' OR ((aa.name->>'en_US') ILIKE '%%outstanding%%' AND aml.matching_number IS NOT NULL)
        ...
        """
                ...
                #             OR (
                #                 (aa.name->>'en_US') ILIKE 'Outstanding'
                #                 -- aa.code = '6510007'
